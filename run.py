...
if __name__ == '__main__':
    ...
    parser_ir.add_argument("-slide_json", default='/home/jazhan/code/document2slides-main/input/acl_slides_prefilter.json')
    parser_ir.add_argument("-paper_path", default='../input/sciduet_papers/')
    parser_ir.add_argument("-split_path", default="../input/split/")
    parser_ir.add_argument("-ir_model", type=str, default=None)   # 检索加载的模型路径
